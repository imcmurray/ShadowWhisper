...
async function testFeature15() {
  ...
  try {
    ...
    await page.screenshot({ path: '/screenshots/f15-01-in-chat.png' });
    ...
    await page.screenshot({ path: '/screenshots/f15-02-message-typed.png' });
    ...
    await page.screenshot({ path: '/screenshots/f15-03-message-sent.png' });
    ...
    await page.screenshot({ path: '/screenshots/f15-04-second-message.png' });
    console.log('  Screenshot: f15-04-second-message.png');

    // Final screenshot
    await page.screenshot({ path: '/screenshots/f15-final-state.png', fullPage: true });
    ...
    await page.screenshot({ path: '/screenshots/f15-error-state.png' }).catch(() => {});
  } finally {
    await browser.close();
  }
}
